    ...
    public class ImageHandle1
    {
      ...
      out HTuple hv_Column, out HTuple hv_Radius, out HTuple hv_Distance)
        ...
        HObject ho_ImageOut = null, ho_ImageMean, ho_ImageScaled;
            ...
            HObject ho_DilationCircle, ho_ErosionCircle;
            ...
            HOperatorSet.GenEmptyObj(out ho_DilationCircle);
            HOperatorSet.GenEmptyObj(out ho_ErosionCircle);
            hv_Row = new HTuple();
            ...
            ho_ErosionCircle.Dispose();
            HOperatorSet.ErosionCircle(ho_Regions1, out ho_ErosionCircle, 10);

            ho_ConnectedRegions.Dispose();
            HOperatorSet.Connection(ho_ErosionCircle, out ho_ConnectedRegions);
            ...
            if ((int)(new HTuple(hv_Number.TupleEqual(1))) != 0)
            {
                ...
                HOperatorSet.InnerCircle(ho_DilationCircle, out hv_Row, out hv_Column, out hv_Radius);
                ho_Circle.Dispose();
